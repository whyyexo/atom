...
Visit [`http://localhost:3000`](http://localhost:3000) to see the marketing homepage. Authenticated routes live under `/dashboard` and are protected by Clerk; use the built-in sign-in/sign-up pages to authenticate.
