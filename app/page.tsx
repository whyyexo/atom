        ...
        >
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[#0071e3] px-6 py-3 text-sm font-normal text-white transition-all hover:bg-[#0077ed] hover:shadow-sm"
            >
