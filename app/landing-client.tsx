...
function DownloadPromoSection() {
  return (
    <section className="relative py-24 bg-gradient-to-br from-white via-[#f8f8f8] to-[#f0f0f0] overflow-hidden">
      <div className="absolute -left-16 top-10 w-72 h-72 rounded-full bg-black/5 blur-3xl pointer-events-none" />
      <div className="max-w-6xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 relative z-10">
          ...
          <Link
            href="/download"
            className="inline-flex items-center gap-3 rounded-lg px-5 py-3 text-sm font-semibold transition-colors hover:bg-gray-50"
          ...
          >
            ...
            <span className="text-sm font-semibold leading-tight" style={{ color: '#000000' }}>Download</span>
          </Link>
        </div>

        <div className="relative h-[260px] sm:h-[300px] lg:h-[340px] overflow-hidden rounded-2xl border border-white shadow-[0_20px_60px_-35px_rgba(0,0,0,0.15)]">
          {/* Light effect on top-left corner */}
          <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-white/80 via-white/40 to-transparent blur-xl pointer-events-none z-10" />
          <div className="absolute top-0 left-0 w-24 h-24 bg-white/60 blur-lg pointer-events-none z-10" />
          <Image
